    ...
    return function() {
        ...
        var t = {
            ...
            853: function(t, e, i) {
                ...
                }, []), m = "beforeRead", y = "read", _ = "afterRead", b = "beforeMain", w = "main", E = "afterMain", O = "beforeWrite", L = "write", x = "afterWrite", A = [
                    m,
                    y,
                    _,
                    b,
                ...
                var Z = {
                    ...
                    phase: "main",
                    fn: function(t) {
                        var e, i = t.state, a = t.name, l = t.options, d = i.elements.arrow, u = i.modifiersData.popperOffsets, p = I(i.placement), f = G(p), h = [
                            s,
                            r
                        ...
                        if (d && u) {
                            ...
                            }(l.padding, i), v = W(d), m = "y" === f ? n : s, y = "y" === f ? o : r, _ = i.rects.reference[h] + i.rects.reference[f] - u[f] - i.rects.popper[h], b = u[f] - i.rects.reference[f], w = Y(d), E = w ? "y" === f ? w.clientHeight || 0 : w.clientWidth || 0 : 0, O = _ / 2 - b / 2, L = g[m], x = E - v[h] - g[y], A = E / 2 - v[h] / 2 + O, k = J(L, A, x), T = f;
                ...
                function et(t) {
                    ...
                    y = w.x, b = w.y;
                    var E = u.hasOwnProperty("x"), O = u.hasOwnProperty("y"), L = s, x = n, A = window;
                    if (h) {
                        var k = Y(i), j = "clientHeight", P = "clientWidth";
                ...
                function pt(t) {
                    return [
                        ...
                        "body",
                        "#document"
                    ].indexOf(k(t)) >= 0 ? t.ownerDocument.body : P(t) && ut(t) ? t : pt(U(t));
                }
                function ft(t, e) {
                    var i;
                    void 0 === e && (e = []);
                ...
                function vt(t, e, i, n) {
                    var o = "clippingParents" === e ? function(t) {
                        var e = ft(U(t)), i = [
                            "absolute",
                            "fixed"
                        ].indexOf(R(t).position) >= 0 && P(t) ? Y(t) : t;
                ...
                function yt(t, e) {
                    ...
                    var i = e, s = i.placement, a = void 0 === s ? t.placement : s, l = i.strategy, d = void 0 === l ? t.strategy : l, g = i.boundary, v = void 0 === g ? u : g, m = i.rootBoundary, y = void 0 === m ? p : m, _ = i.elementContext, b = void 0 === _ ? f : _, w = i.altBoundary, E = void 0 !== w && w, O = i.padding, L = void 0 === O ? 0 : O, x = K("number" != typeof L ? L : Q(L, c)), A = b === f ? h : f, k = t.rects.popper, T = t.elements[E ? A : b], P = vt(j(T) ? T : T.contextElement || N(t.elements.popper), v, y, d), C = V(t.elements.reference), S = mt({
                        ...
                        strategy: "absolute",
                        placement: a
                    }), I = ht(Object.assign({}, k, S)), D = b === f ? I : C, M = {
                ...
                var _t = {
                    ...
                    fn: function(t) {
                        ...
                        if (!e.modifiersData[d]._skip) {
                            for(var u = i.mainAxis, p = void 0 === u || u, f = i.altAxis, h = void 0 === f || f, m = i.fallbackPlacements, y = i.padding, _ = i.boundary, b = i.rootBoundary, w = i.altBoundary, E = i.flipVariations, O = void 0 === E || E, L = i.allowedAutoPlacements, x = e.options.placement, A = I(x), k = m || (A === x || !O ? [
                                st(x)
                            ] : function(t) {
                                if (I(t) === a) return [];
                                var e = st(t);
                ...
                var xt = {
                    ...
                    fn: function(t) {
                        var e = t.state, i = t.options, a = t.name, c = i.mainAxis, d = void 0 === c || c, u = i.altAxis, p = void 0 !== u && u, f = i.boundary, h = i.rootBoundary, g = i.altBoundary, v = i.padding, m = i.tether, y = void 0 === m || m, _ = i.tetherOffset, b = void 0 === _ ? 0 : _, w = yt(e, {
                            ...
                            padding: v,
                            altBoundary: g
                        }), E = I(e.placement), O = $(e.placement), L = !O, x = G(E), A = "x" === x ? "y" : "x", k = e.modifiersData.popperOffsets, T = e.rects.reference, j = e.rects.popper, P = "function" == typeof b ? b(Object.assign({}, e.rects, {
                            placement: e.placement
                        })) : b, C = "number" == typeof P ? {
                            mainAxis: P,
                            altAxis: P
                        ...
                        if (k) {
                            if (d) {
                                var H, B = "y" === x ? n : s, V = "y" === x ? o : r, z = "y" === x ? "height" : "width", R = k[x], F = R + w[B], N = R - w[V], U = y ? -j[z] / 2 : 0, X = O === l ? T[z] : j[z], K = O === l ? -j[z] : -T[z], Q = e.elements.arrow, Z = y && Q ? W(Q) : {
                                    width: 0,
                                    height: 0
                                    ...
                                    bottom: 0,
                                    left: 0
                                }, et = tt[B], it = tt[V], nt = J(0, T[z], Z[z]), ot = L ? T[z] / 2 - U - nt - et - C.mainAxis : X - nt - et - C.mainAxis, rt = L ? -T[z] / 2 + U + nt + it + C.mainAxis : K + nt + it + C.mainAxis, st = e.elements.arrow && Y(e.elements.arrow), at = st ? "y" === x ? st.clientTop || 0 : st.clientLeft || 0 : 0, ct = null != (H = null == S ? void 0 : S[x]) ? H : 0, lt = R + rt - ct, dt = J(y ? M(F, R + ot - ct - at) : F, R, y ? D(N, lt) : N);
                                k[x] = dt, q[x] = dt - R;
                            }
                            if (p) {
                                var ut, pt = "x" === x ? n : s, ft = "x" === x ? o : r, ht = k[A], gt = "y" === A ? "height" : "width", vt = ht + w[pt], mt = ht - w[ft], _t = -1 !== [
                                    n,
                                    s
                                ].indexOf(E), bt = null != (ut = null == S ? void 0 : S[A]) ? ut : 0, wt = _t ? vt : ht - T[gt] - j[gt] - bt + C.altAxis, Et = _t ? ht + T[gt] + j[gt] - bt - C.altAxis : mt, Ot = y && _t ? function(t, e, i) {
                                    var n = J(t, e, i);
                                    return n > i ? i : n;
        ...
        return function() {
            ...
            var e = i(902), o = i(33), r = i(922), s = i(556), a = i(791), c = i(340), l = i(316), d = i(16), u = i(903), p = i(247), f = i(671), h = i(947);
            new h.default("load", [
                e.initAccordions,
                r.initCollapses,
                o.initCarousels,
